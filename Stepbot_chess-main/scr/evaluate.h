...
void incremental_eval_add_piece(IncrementalEvalState& state, int sq, int piece);
void incremental_eval_remove_piece(IncrementalEvalState& state, int sq, int piece);
